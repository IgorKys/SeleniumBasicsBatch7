...
public class ActionsClassRecap extends CommonMethods {
	...
	/*
	 * What is Actions class and why do we need it? 1. We need simulate mouse and
	 * keyboard actions 2. Some elements may not be available before we hover the
	 * mouse on it
	 */
	...
	public static void main(String[] args) throws InterruptedException {
		...
		/*
		 * most common methods for Actions class for mouse 1. click() 2. doubleClick()
		 * 3. contextClick() 4. moveToElement() 5. dragAndDrop(WebElement src,
		 * WebElement dest)
		 * 
		 * What are the most common keyboard operations 1. TAB 2. CTRL 3. SHIFT 4.
		 * keyDown() 5. keyUp()
		 */
